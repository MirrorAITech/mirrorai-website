    ...
    <div className="bg-white text-gray-900 font-sans min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 py-20">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-blue-800 drop-shadow">对抗测试</h2>
          <p className="text-blue-900/80 mb-2 px-8 md:px-40">对抗测试帮助您在风险影响真实用户之前，识别AI应用中的潜在隐患。通过模拟具有挑战性的真实场景，系统全面检验AI在高压条件下的响应表现，揭示其盲点、决策不一致与潜在故障。您只需选择关注的测试场景，我们将自动完成其余流程，为您提供构建更安全、更可靠AI所需的关键洞察。</p>
        </div>
      </section>
