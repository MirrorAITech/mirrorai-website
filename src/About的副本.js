    ...
    >
      ...
      {open && (
        <div className="absolute left-0 top-full mt-2 bg-white border border-blue-100 rounded-lg shadow-lg min-w-[160px] z-30 animate-fade-in">
          <a href="/benchmark" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 whitespace-nowrap">基准测试</a>
          <a href="/adversarial" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 whitespace-nowrap">对抗测试</a>
          <a href="/redteaming" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 whitespace-nowrap">红队测试</a>
          <a href="/multilanguage" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 whitespace-nowrap">多语言测试</a>
        </div>
      )}
    </div>
  );
...
function MonitorDropdown() {
  ...
  return (
    ...
    >
      ...
      {open && (
        <div className="absolute left-0 top-full mt-2 bg-white border border-blue-100 rounded-lg shadow-lg min-w-[160px] z-30 animate-fade-in">
          <a href="/modelmonitor" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 whitespace-nowrap">模型监控</a>
          <a href="/agentmonitor" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 whitespace-nowrap">智能体监控</a>
        </div>
      )}
    </div>
  );
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-blue-900">
              <li>
                <a href="/benchmark" className="hover:text-blue-600 underline">基准测试</a>
              </li>
              <li>
                <a href="/adversarial" className="hover:text-blue-600 underline">对抗测试</a>
              </li>
              <li>
                <a href="/redteaming" className="hover:text-blue-600 underline">红队测试</a>
              </li>
              <li>
                <a href="/multilanguage" className="hover:text-blue-600 underline">多语言测试</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-blue-900">
              <li>
                <a href="/modelmonitor" className="hover:text-blue-600 underline">模型监控</a>
              </li>
              <li>
                <a href="/agentmonitor" className="hover:text-blue-600 underline">智能体监控</a>
              </li>
            </ul>
          </div>
          <div>
