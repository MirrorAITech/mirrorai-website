    ...
    <div className="bg-white text-gray-900 font-sans min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 py-20">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-blue-800 drop-shadow">红队测试</h2>
          <p className="text-blue-900/80 mb-2 px-8 md:px-40">红队测试模块将繁复的合规要求转化为可执行的测试任务，帮助您主动发现系统中潜在的违规风险。从内部政策到国际法规，无论是企业规范、行业特定标准，还是国家法律，您只需上传相关合规文件，我们即会自动完成行为映射与差距分析，智能识别模型行为与规范之间的偏差，助力您的AI产品实现安全、可控、合规落地。</p>
        </div>
      </section>
