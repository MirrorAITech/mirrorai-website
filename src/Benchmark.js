    ...
    <div className="bg-white text-gray-900 font-sans min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 py-20">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-blue-800 drop-shadow">基准测试</h2>
          <p className="text-blue-900/80 mb-2 px-8 md:px-40">基准测试模块可在用户发现问题之前，帮助您识别AI应用中潜在的薄弱环节。依托自研的内部提示库，系统构造贴近真实场景的安全挑战，对模型响应进行多维度评测，从而提前洞察潜在失效点，助力提升AI系统的可靠性、安全性与可信度。</p>
        </div>
      </section>
