    ...
    <div className="bg-white text-gray-900 font-sans min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 py-20">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-blue-800 drop-shadow">智能体监控</h2>
          <p className="text-blue-900/80 mb-2 px-8 md:px-40">智能体监控模块致力于在AI代理执行任务之前实现精确控制，确保每个智能体仅在授权范围内安全运行。随着AI在业务流程中的自动化程度不断提升，该模块通过设定清晰的操作边界、持续监测执行行为、防止越权访问与违规操作，帮助企业构建透明、合规、可控的智能体运行体系，有效防范潜在风险，保障组织安全与责任边界。</p>
        </div>
      </section>
