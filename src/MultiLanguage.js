    ...
    <div className="bg-white text-gray-900 font-sans min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 py-20">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-blue-800 drop-shadow">多语言测试</h2>
          <p className="text-blue-900/80 mb-2 px-8 md:px-40">多语言测试模块助您打造真正“全球可用”的可信AI系统。随着AI在全球范围内落地应用，模型需在不同语言、文化及用户期望下保持一致的安全性。多语言安全测试是一套面向多语境的综合评估工具，可系统检测AI应用在多语言环境中的表现，提前发现语言相关风险，避免其影响真实用户。</p>
        </div>
      </section>
